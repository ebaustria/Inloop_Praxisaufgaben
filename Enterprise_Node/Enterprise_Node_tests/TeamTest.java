...
public class TeamTest {
    ...
    public void testGetTeamMembersWithoutTeam() {
        assertEquals("Team.getTeamMembers() should return a sorted list of all of the Team's members!", Arrays.asList(teamLeader),
                team.getTeamMembers());
    }

    @Test
    public void testGetTeamMembersWithTeam() {
        assertEquals("Team.getTeamMembers() should return a sorted list of all of the Team's members!", createTeamHierarchy(teamLeader),
                team.getTeamMembers());
    }
